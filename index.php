...
<header> 
  <!-- Fixed navbar -->
  <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark"> <a class="navbar-brand" href="#">APNACC</a>
...
<div class="container">
  <h3 class="mt-5" style="text-align: center;">Asociación de padres de niños y adolescentes con cáncer</h3>
  <hr>
  <div class="row">
      ...
      <div class="signup-form-container"> 
        ...
        <form method="post" role="form" id="register-form" autocomplete="off">
          <div class="form-header">
            ...
            <span class="glyphicon glyphicon-user"></span> Convierte en socio</h3>
          </div>
          <div class="form-body"> 
...
<footer class="footer">
  <div class="container"> <span class="text-muted">
    <p>Todos los Derechos Reservados<a href="www.apnacc.com" target="_blank"> © APNACC 2019</a></p>
    </span> </div>
</footer>
